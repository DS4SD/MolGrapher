...
def main():
    ...
    if mode == "fine-tuning":
        model = GraphClassifier.load_from_checkpoint(
            ...
            + f"/../../../data/models/graph_classifier/{config_training['checkpoint']}.ckpt",
    ...
    print(
        f"Number of training iterations: {nb_iterations} (Four validations per epoch)"
    )
