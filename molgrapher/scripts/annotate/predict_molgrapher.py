...
def main():
    ...
    parser.add_argument('--force-cpu', action = argparse.BooleanOptionalAction, default = False, required = False)
    parser.add_argument('--force-no-multiprocessing', action = argparse.BooleanOptionalAction, default = True, required = False)
    ...
    parser.add_argument('--node-classifier-variant', type = str, default = "gc_no_stereo_model")
