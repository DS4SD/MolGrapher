...
class Img2Mol(pl.LightningModule):
    def __init__(self):
        ...
        self.img2mol_model = Img2MolInference(model_ckpt = img2mol_path + "model/model.ckpt", device="cpu")
    ...
    def predict(self, images_filenames):
        ...
        for image_path in images_filenames:
            smiles_batch.append(self.img2mol_model(filepath=image_path, cddd_server=self.cddd_server)["smiles"])
